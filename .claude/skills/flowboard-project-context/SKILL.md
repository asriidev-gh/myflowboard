...
description: My-FlowBoard (TrelloReplica) architecture, conventions, commands, and testing. Use for any work in this repo — features, bugs, Prisma, auth, boards, E2E, or Phase 10 hardening.
***
