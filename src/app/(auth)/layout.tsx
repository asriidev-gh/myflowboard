...
export default async function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-svh flex-col bg-[radial-gradient(1200px_600px_at_10%_-10%,color-mix(in_oklch,var(--brand)_18%,transparent),transparent),radial-gradient(900px_500px_at_90%_0%,color-mix(in_oklch,var(--brand-to)_16%,transparent),transparent)]">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center gap-10 px-4 pb-16 md:flex-row md:items-stretch md:gap-16">
        <section className="hidden max-w-md flex-1 flex-col justify-center md:flex">
          <p className="font-heading text-4xl font-semibold tracking-tight text-foreground">
            {branding.name}
          </p>
          <p className="mt-3 text-lg text-muted-foreground">
            {branding.tagline}. {branding.shortDescription}.
          </p>
